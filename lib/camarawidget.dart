...
codecontroller=phonecontroller.text.substring(0, 4);
    ...
    final int? codegenerator = int.tryParse(phonecontroller.text.substring(0, 4));
    print("length");
    ...
    if (phonecontroller.text.length < 10) {
      ...
      // await _QUEUES .add({"CLIENT_NAME": nombre, "PHONE":phone, "SUBJECTS": asunto});
      setState(() {
        print(phonecontroller.text);
        names.add(namecontroller.text);
        phones.add(phonecontroller.text);
        codes.add(phonecontroller.text.substring(0, 4)+phonecontroller.text.substring(6, 7));
        _counter++;
      });
    }
  }
